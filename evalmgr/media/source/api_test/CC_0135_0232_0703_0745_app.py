...
def add_user():
    ...
    return f"user {rjson['username']} created"
...
def remove_user(username):
    ...
    return f'user {username} has been removed', 200
...
def create_new_ride():
    ...
    return 'ride created successfully', 200
...
def join_ride(rideId):
    ...
    read = post("http://35.174.170.204/api/v1/db/read", json=wjson)
    if read.status_code == 400:
        return 'already memeber of ride', 400
