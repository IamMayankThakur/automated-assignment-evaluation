...
def Add_user():
    ...
    try:
        ...
        return Response(status=400)    #return response message as invalid password



    r=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/read',
    json={
        'table':'User',
        'columns':['username'],
    ...
    if count>0:
        ...
        return Response(status=400)      #return username already exists
        
        #return json.dumps(res)
    else:
        r=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/write',
        json={
            'table':'User',
            'flag':0,
        ...
        if count==1:
            ...
            #res["count"]=count
            return Response(status=400)   #return couldn't be created
            #return json.dumps(res)
...
def REMOVE_user(username):
    ...
    if count>0:
        ...
        #if status_code==200:
         #   return Response(status=400)
        return Response(status=400)    #return username doesn't exist
...
def ADD_ride():
    ...
    count=r.json().get("count")
    if count>0:
        r1=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/read',
        json={
            'table':'Area',
            'columns':['areaname'],
        ...
        if count1>0:
            r2=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/read',
            json={
                'table':'Area',
                'columns':['areaname'],
            ...
            if count2>0:
                r3=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/write',
                json={
                    'table':'Ride',
                    'flag':0,
                ...
                if count3==1:
                    ...
                    return Response(status=400)     #return 

            else:
                return Response(status=400)     #return dest doesn't exist
        
        else:
            return Response(status=400)    #return source doesn't exist
    ...
    if count1>0:
        ...
        if count2>0:
            ...
            if count>0:
                ...
                return Response(status=204)    #no upcoming rides

            else:
                return Response(status=400)    #invalid source or destination
        
        else:
            return Response(status=400)  #invalid destination
    
    else:
        return Response(status=400) #invalid source
...
def join_ride(rideId):
    ...
    if count>0:
        ...
        if count1>0:
            r2=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/write',
            json={
                "table":"RideUser",
            ...
            if count2>0:
                ...
                return Response(status=400)    #unsuccessful

        else:
            return Response(status=400)    #user doesn't exist

    else:
        return Response(status=400)   #invalid rideid, rideid doesn't exist
...
def delete_ride(rideId):
    ...
    count=r.json().get("count")
    if count>0:
        r1=requests.post('http://ec2-3-82-148-153.compute-1.amazonaws.com/api/v1/db/write',
        json={
            "table":"Ride",
            "flag":1,
