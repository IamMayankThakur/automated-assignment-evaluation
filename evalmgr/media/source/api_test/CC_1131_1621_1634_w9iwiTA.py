...
def add_user():
	...
	url= 'http://ec2-3-222-120-11.compute-1.amazonaws.com/api/v1/db/read'
	...
	url= 'http://ec2-3-222-120-11.compute-1.amazonaws.com/api/v1/db/write'
	p=requests.post(url,data=post)
	t=p.text
	return "",201
