...
def getRides():
    ...
    destn = int(request.args.get('destination'))

    # Source and the Destination in the url params must exist, otherwise send the appropriate response code from the given list.
    if source not in range(1, 199) or destn not in range(1, 199):
        abort(400)
