...
def add_user():
        if request.method == 'PUT':
                ...
                usr = {key:data[key]}
                resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=usr)
                if(resp_send.status_code==400):
                        ...
                        if match:
                                data["query"]="insert"
                                resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/write",json=data)
                                return jsonify({}),201
                        else:
                                return jsonify({}),400
                else:
...
#     data = json(d)
                print("hey")
                resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=data)
                print("hi")
...
def remove_user(username):
        if request.method == 'DELETE':
                ...
                if(resp_send.status_code == 400):
                        ...
                        data["dtype"]="del_two"
                        resp_del = requests.delete("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/write",json=data)
                return jsonify({}),200
        else:
                return jsonify({}),405
...
def create_new_ride():
        if request.method == 'POST':
                ...
                resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=usrd)
                ...
                if(resp_send.status_code==200):
                        ...
                        fata["query"]="insert"
                        resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/write",json=fata)
                        print("received")
                        return jsonify({}),201
                else:
...
def details_of_rides(rideId):
        if request.method == 'GET':
                ...
                resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=usr)
                resp_send1 = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=data1)
                if(resp_send.status_code==200 and resp_send1.status_code==200):
                        ...
                        if usr["username"] not in d["users"]:
                                resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/write",json=od)
                ...
                data = {"rideId":int(rideId)}
                resp_send1 = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=data)
                if resp_send1.status_code==400:
                        return jsonify({}),400
                elif (resp_send1.status_code==200):
                        data["dtype"]="del_one"
                        resp_send = requests.delete("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/write",json=data)
...
def write_data():
        if request.method == 'POST':
                ...
                if data["dtype"]=='del_one':
                        ...
                        key="created_by"
                        d={key:usr}
                        resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json=d)
                        if (resp_send.status_code==400):
                                print("chaarsoo")
                                return jsonify({}),400
                        res = json.loads(resp_send.content)
                        ...
                        resp_send = requests.post("http://ec2-54-84-34-218.compute-1.amazonaws.com/api/v1/db/read",json={})
                        res = json.loads(resp_send.content)
