...
def add_user():
    ...
    if(len(data)==2):
        ...
        if(pas>0):
            ...
            check_user = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = myobj)            
            if(str(check_user.status_code)=="400"):
                response = requests.post("http://127.0.0.1:5000/api/v1/db/write",json = myobj)
...
def remove_user(username):
    ...
    if(str(check_user.status_code)=="200"):
        ...
        ride_status = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = ride_present)
...
def new_ride():
    ...
    max_id = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = ride_obj)
...
def list_ride():
    ...
    if(place_present==1):
        ...
        # return myobj
        list_ride = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = myobj)
...
def join_ride(rideId):
    ...
    check_ride = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = rideobj)
    if(str(check_ride.status_code)=="200"):
        ride_status_obj = {"table":"Join","action":"ride_status","rideId":rideId,"user_name":user_name}
        ride_status = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = ride_status_obj)
        if(str(ride_status.status_code)=="200"):
            response_ = Response(status=400)#user already added to the ride
            return response_
        else:
            join_ride = requests.post("http://127.0.0.1:5000/api/v1/db/write",json = ride_status_obj)
...
def ride_detail(rideId):
    ...
    if(str(check_ride.status_code)=="200"):
        ...
        ride_detail1 = requests.post("http://127.0.0.1:5000/api/v1/db/read",json = rideobj1)
...
def ride_delete(rideId):  
    ...
    # return str(check_ride.status_code)
    if(str(check_ride.status_code)=="200"):
        del_ride = requests.post("http://127.0.0.1:5000/api/v1/db/write",json = rideobj)
        # ride =session.query(Ride2).get(ride_id)
