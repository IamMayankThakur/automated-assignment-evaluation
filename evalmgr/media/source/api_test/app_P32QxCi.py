...
def add_user():
    print("------- [API 1] ------- [CALL {}] ------- [{}] ------- START ADD USER -------".format(which_call, str(datetime.now())))
    print("------- [API 1] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), request.get_json()))
    which_call += 1
...
def delete_user(username):
    print("------- [API 2] ------- [CALL {}] ------- [{}] ------- START DELETE USER -------".format(which_call, str(datetime.now())))
    print("------- [API 2] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), username))
    which_call += 1
...
def create_ride():
    print("------- [API 3] ------- [CALL {}] ------- [{}] ------- START CREATE USER -------".format(which_call, str(datetime.now())))
    print("------- [API 3] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), request.get_json()))
    which_call += 1
...
def getRides():
    print("------- [API 4] ------- [CALL {}] ------- [{}] ------- START GET UPCOMING RIDES -------".format(which_call, str(datetime.now())))
    print("------- [API 4] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), (request.args.get('source'), request.args.get('destination'))))
    which_call += 1
    ...
    if len(read_result.json()) == 0:
        print("No rides found with given source and destination")
        abort(400)
    else:
        net_response = []
        now = datetime.now()
        ...
        if len(net_response) == 0:
            print("No rides found with timestamp")
            abort(400)
...
def getRideDetails(rideId):
    print("------- [API 5] ------- [CALL {}] ------- [{}] ------- START GET RIDE DETAILS -------".format(which_call, str(datetime.now())))
    print("------- [API 5] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), rideId))
    which_call += 1
...
def addUser(rideid):
    print("------- [API 6] ------- [CALL {}] ------- [{}] ------- START JOIN EXISTING RIDE -------".format(which_call, str(datetime.now())))
    print("------- [API 6] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), (request.get_json(),rideId)))
    which_call += 1
    req_params = request.get_json()
...
def delete_ride(rideid):
    print("------- [API 7] ------- [CALL {}] ------- [{}] ------- START DELETE USER -------".format(which_call, str(datetime.now())))
    print("------- [API 7] ------- [CALL {}] ------- [{}] ------- REQUEST: {} -------".format(which_call, str(datetime.now()), rideid))
    which_call += 1
